...
Taille_Non_Compatible_a : exception;
Taille_Non_Compatible_m : exception;
  ...
  -- exception qui doit etre levee si les parametres d'une fonction ne permettent pas l'operation
  -- souhaitee
